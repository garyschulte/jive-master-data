...
public class Search extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8943422036421285369L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Search\",\"namespace\":\"com.jivesoftware.community.cloudalytics.schemata\",\"fields\":[{\"name\":\"keywords\",\"type\":{\"type\":\"string\",\"order\":\"ignore\"}},{\"name\":\"searchSelectedId\",\"type\":\"long\"},{\"name\":\"searchSelectedType\",\"type\":\"string\"},{\"name\":\"queries\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"searchFinalQuery\",\"type\":\"string\"}]}");
   ...
   */
  public Search(java.lang.CharSequence keywords, java.lang.Long searchSelectedId, java.lang.CharSequence searchSelectedType, java.util.List<java.lang.CharSequence> queries, java.lang.CharSequence searchFinalQuery) {
   ...
   * @return A new Search RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.schemata.Search.Builder newBuilder() {
    return new com.jivesoftware.community.cloudalytics.schemata.Search.Builder();
  }
   ...
   * @return A new Search RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.schemata.Search.Builder newBuilder(com.jivesoftware.community.cloudalytics.schemata.Search.Builder other) {
    return new com.jivesoftware.community.cloudalytics.schemata.Search.Builder(other);
  }
   ...
   * @return A new Search RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.schemata.Search.Builder newBuilder(com.jivesoftware.community.cloudalytics.schemata.Search other) {
    return new com.jivesoftware.community.cloudalytics.schemata.Search.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Search>
    ...
    private Builder() {
      super(com.jivesoftware.community.cloudalytics.schemata.Search.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.schemata.Search.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.schemata.Search other) {
            super(com.jivesoftware.community.cloudalytics.schemata.Search.SCHEMA$);
      if (isValidValue(fields()[0], other.keywords)) {
        this.keywords = data().deepCopy(fields()[0].schema(), other.keywords);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder setKeywords(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder clearKeywords() {
      keywords = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder setSearchSelectedId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder clearSearchSelectedId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder setSearchSelectedType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder clearSearchSelectedType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder setQueries(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder clearQueries() {
      queries = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder setSearchFinalQuery(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.schemata.Search.Builder clearSearchFinalQuery() {
