...
public class AvroAttachment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1335438057468970915L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroAttachment\",\"namespace\":\"com.jivesoftware.community.cloudalytics.event.avro\",\"fields\":[{\"name\":\"mimeType\",\"type\":{\"type\":\"string\",\"order\":\"ignore\"}},{\"name\":\"fileName\",\"type\":\"string\"},{\"name\":\"attachmentSize\",\"type\":\"int\"},{\"name\":\"contentDataAvailable\",\"type\":\"boolean\"},{\"name\":\"creationDate\",\"type\":\"long\"},{\"name\":\"modificationDate\",\"type\":\"long\"}]}");
   ...
   */
  public AvroAttachment(java.lang.CharSequence mimeType, java.lang.CharSequence fileName, java.lang.Integer attachmentSize, java.lang.Boolean contentDataAvailable, java.lang.Long creationDate, java.lang.Long modificationDate) {
   ...
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder newBuilder() {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder();
  }
   ...
   * @return A new AvroAttachment RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder(other);
  }
   ...
   * @return A new AvroAttachment RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroAttachment>
    ...
    private Builder() {
      super(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment other) {
            super(com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.SCHEMA$);
      if (isValidValue(fields()[0], other.mimeType)) {
        this.mimeType = data().deepCopy(fields()[0].schema(), other.mimeType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setMimeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearMimeType() {
      mimeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setFileName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearFileName() {
      fileName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setAttachmentSize(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearAttachmentSize() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setContentDataAvailable(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearContentDataAvailable() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setCreationDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearCreationDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder setModificationDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroAttachment.Builder clearModificationDate() {
