...
public class AvroTileInstance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 587983917343701032L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroTileInstance\",\"namespace\":\"com.jivesoftware.community.cloudalytics.event.avro\",\"fields\":[{\"name\":\"tileDefinitionObjectType\",\"type\":{\"type\":\"string\",\"order\":\"ignore\"}},{\"name\":\"tileDefinitionObjectId\",\"type\":\"long\"},{\"name\":\"tileDefinitionName\",\"type\":\"string\"},{\"name\":\"tileDefinitionVisualType\",\"type\":\"string\"},{\"name\":\"isActivityStream\",\"type\":\"boolean\"},{\"name\":\"extensionUUID\",\"type\":\"string\"}]}");
   ...
   */
  public AvroTileInstance() {}

  /**
   * All-args constructor.
   */
  public AvroTileInstance(java.lang.CharSequence tileDefinitionObjectType, java.lang.Long tileDefinitionObjectId, java.lang.CharSequence tileDefinitionName, java.lang.CharSequence tileDefinitionVisualType, java.lang.Boolean isActivityStream, java.lang.CharSequence extensionUUID) {
  ...
  /**
   * Creates a new AvroTileInstance RecordBuilder.
   * @return A new AvroTileInstance RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder newBuilder() {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder();
  }
  
  /**
   * Creates a new AvroTileInstance RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroTileInstance RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder(other);
  }
  
  /**
   * Creates a new AvroTileInstance RecordBuilder by copying an existing AvroTileInstance instance.
   * @param other The existing instance to copy.
   * @return A new AvroTileInstance RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder(other);
  }
  
  /**
   * RecordBuilder for AvroTileInstance instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTileInstance>
    implements org.apache.avro.data.RecordBuilder<AvroTileInstance> {
    ...
    private Builder() {
      super(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroTileInstance instance
     * @param other The existing instance to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance other) {
            super(com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.SCHEMA$);
      if (isValidValue(fields()[0], other.tileDefinitionObjectType)) {
        this.tileDefinitionObjectType = data().deepCopy(fields()[0].schema(), other.tileDefinitionObjectType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setTileDefinitionObjectType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearTileDefinitionObjectType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setTileDefinitionObjectId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearTileDefinitionObjectId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setTileDefinitionName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearTileDefinitionName() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setTileDefinitionVisualType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearTileDefinitionVisualType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setIsActivityStream(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearIsActivityStream() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder setExtensionUUID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroTileInstance.Builder clearExtensionUUID() {
      extensionUUID = null;
    ...
    @Override
    public AvroTileInstance build() {
      try {
        AvroTileInstance record = new AvroTileInstance();
