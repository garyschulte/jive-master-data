...
public class AvroUserRewardBadge extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -768030418253711752L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroUserRewardBadge\",\"namespace\":\"com.jivesoftware.community.cloudalytics.event.avro\",\"fields\":[{\"name\":\"badgeId\",\"type\":{\"type\":\"string\",\"order\":\"ignore\"}},{\"name\":\"userEmail\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"},{\"name\":\"streamEntryId\",\"type\":\"string\"},{\"name\":\"streamEntryUrl\",\"type\":\"string\"}]}");
   ...
   */
  public AvroUserRewardBadge() {}

  /**
   * All-args constructor.
   */
  public AvroUserRewardBadge(java.lang.CharSequence badgeId, java.lang.CharSequence userEmail, java.lang.CharSequence message, java.lang.CharSequence streamEntryId, java.lang.CharSequence streamEntryUrl) {
  ...
  /**
   * Creates a new AvroUserRewardBadge RecordBuilder.
   * @return A new AvroUserRewardBadge RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder newBuilder() {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder();
  }
  
  /**
   * Creates a new AvroUserRewardBadge RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroUserRewardBadge RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder(other);
  }
  
  /**
   * Creates a new AvroUserRewardBadge RecordBuilder by copying an existing AvroUserRewardBadge instance.
   * @param other The existing instance to copy.
   * @return A new AvroUserRewardBadge RecordBuilder
   */
  public static com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder newBuilder(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge other) {
    return new com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder(other);
  }
  
  /**
   * RecordBuilder for AvroUserRewardBadge instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroUserRewardBadge>
    implements org.apache.avro.data.RecordBuilder<AvroUserRewardBadge> {
    ...
    private Builder() {
      super(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroUserRewardBadge instance
     * @param other The existing instance to copy.
     */
    private Builder(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge other) {
            super(com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.SCHEMA$);
      if (isValidValue(fields()[0], other.badgeId)) {
        this.badgeId = data().deepCopy(fields()[0].schema(), other.badgeId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder setBadgeId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder clearBadgeId() {
      badgeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder setUserEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder clearUserEmail() {
      userEmail = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder setStreamEntryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder clearStreamEntryId() {
      streamEntryId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder setStreamEntryUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jivesoftware.community.cloudalytics.event.avro.AvroUserRewardBadge.Builder clearStreamEntryUrl() {
      streamEntryUrl = null;
    ...
    @Override
    public AvroUserRewardBadge build() {
      try {
        AvroUserRewardBadge record = new AvroUserRewardBadge();
